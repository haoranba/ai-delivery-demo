...
const MOCK_EXPERIENCES: PracticalExperience[] = [
  {
    id: 'exp-1',
    type: 'pitfall',
  ...
  },
  {
    ...
    createdAt: '1天前',
    contributions: [
      { author: 'wangfang', avatar: '👩‍💼', date: '1天前', signal: 'rejected',
        userMessage: 'for 循环里根据 userId 查询用户详情',
        aiResponse: '建议改为 IN 查询批量获取，再用 Map 做 O(1) 关联。', repoKey: '系统知识' },
      { author: 'liming', avatar: '🧑‍🎨', date: '2天前', signal: 'modified',
  ...
  },
  {
    ...
    createdAt: '2天前',
    contributions: [
      { author: 'zhoujian', avatar: '🧑‍💻', date: '2天前', signal: 'rejected',
  ...
  },
  {
    ...
    createdAt: '3天前',
    contributions: [
      { author: 'chenxiao', avatar: '🧑‍🔬', date: '3天前', signal: 'accepted',
  ...
  },
  {
    ...
    createdAt: '5天前',
    contributions: [
      { author: 'wangfang', avatar: '👩‍💼', date: '5天前', signal: 'accepted',
